    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">Editar Modelo de Documento</h1>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="/admin/templates/update" class="needs-validation" novalidate>
                                ...
                                <select class="form-select" id="document_type_id" name="document_type_id" required>
                                    ...
                                    <?php foreach ($documentTypes as $type): ?>
                                        <option value="<?php echo $type['id']; ?>" 
                                                <?php echo ($type['id'] == $template['document_type_id']) ? 'selected' : ''; ?>>
                        ...
                        <div class="mb-3">
                            ...
                            <div id="editor" style="height: 500px; border: 1px solid #ccc;"><?php echo $template['content']; ?></div>
                            <textarea class="d-none" id="content" name="content" required><?php echo htmlspecialchars($template['content']); ?></textarea>
                            <div class="invalid-feedback">
                            ...
                            <div id="variables-container" class="border rounded p-3 bg-light">
                                ...
                                if (!empty($variables)) {
                                    foreach ($variables as $variable) {
                                        echo '<span class="badge bg-primary me-2 mb-2">' . htmlspecialchars($variable) . '</span>';
                                    }
                                } else {
                                    echo '<p class="text-muted">Nenhuma variável detectada. Adicione variáveis usando <code>{{nome_da_variavel}}</code> no conteúdo do modelo.</p>';
                                }
                                ?>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Call detectVariables on page load
    detectVariables();
